...
export const reservationITConfig = {
   ...
   */
  getServiceDateMes:
    APPConfig.baseUrl + 'Service/GetServiceResidual?dept_id={dept_id}',
   ...
   */
  getServiceDayInfo:
    APPConfig.baseUrl + 'Service/GetServiceInfo?dept_id={dept_id}&date={date}',
   ...
   */
  getServiceImpressionResults:
    APPConfig.baseUrl +
    'Service/GetServiceResults?empno={empno}&service_id={service_id}',
  ...
  getPersonImpression:
    APPConfig.baseUrl +
    'Service/GetServiceImpression?empno={empno}&rownum={rownum}',
  ...
  getPersonComment:
    APPConfig.baseUrl +
    'Service/GetServiceComment?dept_id={dept_id}&empno={empno}&rownum={rownum}',
