export const inspectionAttendanceConfig = {
  ...
  APIs: {
    search:
      'IPQA/attendanceInfo?nameID={nameID}&dateFM={dateFM}&dateTO={dateTO}&type={type}',
  },
  additionalFn: {
  ...
  searchSets: [
    ...
    },
    {
      ...
      InputOpts: {
        ...
        more: {
          options: [
            { property: 1, value: '未刷卡' },
            { property: 2, value: '未產生補休' },
  ...
  tableData: {
    ...
    columns: [
      ...
      {
        property: 'ACUTAL_FROM_TIME',
        value: '開始時間',
      },
      {
        property: 'ACTUAL_TO_TIME',
        value: '結束時間',
      },
      {
