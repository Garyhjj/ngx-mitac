...
export const DataDriveStore = {
    ...
    searchSets: [
      {
        ...
        InputOpts: {
          ...
          more: {
            lazyAPI:
              'EXAM/GetExams?id=&title=&ref_dept={ref_dept}&code=&version=&company_id={company_id}',
            lazyParams: ['ID', 'TITLE'],
            lazyAPIUserMes: {
              ref_dept: '',
  ...
  examUnits: 23 || {
    ...
    APIs: {
      search:
        'EXAM/GetExams?id={id}&title={title}&ref_dept={ref_dept}&code={code}&version={version}&company_id={company_id}',
    ...
    updateSets: [
      ...
      },
      {
        ...
        InputOpts: {
          ...
          more: {
            options: [
              { property: 'RADIO', value: '單選' },
              { property: 'CHECKBOX', value: '多選' },
              { property: 'TF', value: '判斷' },
            ],
            // lazyAPI: 'GUID/GetDeptNameBySite?site=MSL'
          },
        },
